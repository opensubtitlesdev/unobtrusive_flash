...
(function() {
  ...
  function nukeCookie(cookieName) {
    ...
    $.each(hostParts, function(i, part) {
      ...
      document.cookie = cookieName + '=; path=/; expires=' + yesterday.toUTCString() + '; domain=' + expireHost + '; SameSite=Strict; Secure';
    });
    document.cookie = cookieName + '=; path=/; expires=' + yesterday.toUTCString() + '; SameSite=Strict; Secure';
  }
